...
func SynchronizedBeforeSuite(process1Body func() []byte, allProcessBody func([]byte)) bool {
	...
	return ginkgo.SynchronizedBeforeSuite(func() []byte {
		test1.Enter("SynchronizedBeforeSuite.process1Body", suiteName)
		defer test1.Leave()
		...
		test2.Enter("SynchronizedBeforeSuite.allProcessBody", suiteName)
		defer test2.Leave()
...
func SynchronizedAfterSuite(allProcessBody func(), process1Body func()) bool {
	...
	return ginkgo.SynchronizedAfterSuite(func() {
		test1.Enter("SynchronizedAfterSuite.allProcessBody", suiteName)
		defer test1.Leave()
		...
		test2.Enter("SynchronizedAfterSuite.process1Body", suiteName)
		defer test2.Leave()
...
func BeforeSuite(userFunc func()) bool {
	...
	return ginkgo.BeforeSuite(func() {
		test.Enter("BeforeSuite", suiteName)
		defer test.Leave()
...
func AfterSuite(userFunc func()) bool {
	...
	return ginkgo.AfterSuite(func() {
		test.Enter("AfterSuite", suiteName)
		defer test.Leave()
...
func RunSpecs(t ginkgo.GinkgoTestingT, description string, args ...interface{}) bool {
	...
	currentSuite.LeaveContainer() // exit initialization step

	currentSuite.EnterContainer("RunSpecs", description)
...
func initSetup() {
	initOnce.Do(func() {
		...
		currentSuite.EnterContainer("PhaseBuildTree", "init")
	})
}
